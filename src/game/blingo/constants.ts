...
export const STATES = [ "STANDARD_SPIN", "FREE_SPIN", "FREE_PURCHASE_SPIN", "PURCHASE_SPIN", "COMPLETE" ];
export const SPINTYPES = [ "STANDARD", "FREE_PURCHASE", "PURCHASE", "FREE", "RESPIN" ];
